...
import '../PagesCss/QuestionsDetails.css'
                ...
                <div key={question._id}>
                  ...
                  </section>
                  {
                    question.noOfAnswers !== 0 && (
                      <section>
                        <h3 style={{padding:'15px 0px' , fontSize:'20px' ,fontWeight:'bolder'}}>{question.noOfAnswers} Answers</h3>
                        <DisplayAnswer key={question._id} question={question} handleShare={handleShare} />
                      </section>
                    )
                  }
                  <section className='post-ans-container'>
                    <h3 style={{padding:'5px 0px'}}>Your Answer</h3>
